...
public class LocalStack extends Stack   {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "SedEg2B8I+f2x76e6MGRaFaGeuDhVvkLN5v0NEN35FORJfpiayCdlMV8q95kZ/vx"));
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVERS","localhost.localstack.cloud:4510 , localhost.localstack" +
                ".cloud:4511, localhost.localstack.cloud:4510" );
    ...
    private void createApiGatewayService(){
        ...
        ContainerDefinitionOptions containerOptions = ContainerDefinitionOptions.builder()
                ...
                .portMappings(List.of(4004).stream()
                        ...
                        .toList())
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this,"ApiGateway LogGroup")
